...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /** since we are dealing with integers, the resulting number will print as an integer as well (a whole number).
         * I believe that the terminal will print an integer of 3, since 3 goes into 10 3 times. The remainder (1) will
         * be dropped.
         */
    }
}
